    ...
    <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped {{ $result->count() > 0 ? 'datatable' : '' }}" id="example">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Title</th>
                    ...
                    @foreach($result as $item)
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <img src="{{asset('uploads/posts').'/'.$item->id.'/'.$image_name}}" width="50" height="50" alt="Post Image"/>
                            <?php } else { ?>
                              <img src="{{asset('img/post_dafult.jpg')}}" width="50" height="50" alt="Post Image"/>
                            <?php } ?>
                            </td>
                            <td>{{ $item->user['name'] }}</td>
                            <td>{{ $item->created_at->toFormattedDateString() }}</td>
                            @can('edit_posts', 'delete_posts','print_posts')
